...
from api.v1.cart.services import CartService
from . import models
...
class CartAdmin(admin.ModelAdmin):
    ...
    def custom_field(self, obj):
        item_list = list(models.Item.objects.filter(cart=obj).values_list('product_id'))
        ...
        # service = CartService(request=self.request, url='/api/v1/product-list/')
